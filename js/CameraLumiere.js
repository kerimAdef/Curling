 function cameraLumiere(scene,camera){   // creation de la camera 
  ...
  var zPos=3.6;//document.forms["controle"].PosZ.value;//*document.forms["controle"].zoom.value;
  var xDir=1;//document.forms["controle"].DirX.value;
  var yDir=1;//document.forms["controle"].DirY.value;
